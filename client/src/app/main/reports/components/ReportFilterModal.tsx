...
const ReportFilterModal: React.FC<FilterModalProps> = ({
    ...
    const sortOptions = [
        ...
        { value: 'least_liked', label: 'Kurang Disukai', icon: <BiLike /> },
    ];
    ...
    const statusOptions = [
        ...
        { value: 'PENDING', label: 'Tertunda', icon: <MdAccessTime />, color: 'yellow' },
        { value: 'ON_PROGRESS', label: 'Dalam Proses', icon: <MdAccessTime />, color: 'blue' },
