...
const Map = () => {
    ...
    const { location, isError, error, loading, permissionDenied, isPermissionDenied, requestLocation } = useCurrentLocation();
                ...
                <div className='bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-3'>
                    {reverseLoading ? (
                        ...
                        <div className="text-xs text-green-600 flex flex-col gap-2">
                            ...
                            <div className="">
                                {(data as ReverseLocationResponse)?.display_name || 'Alamat tidak ditemukan'}
                            </div>
                        </div>
                    ) : (
